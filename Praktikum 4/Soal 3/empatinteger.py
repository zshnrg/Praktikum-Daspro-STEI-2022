...
# Tuliskan realisasi fungsi Max di bawah ini
    return max(a,b,c,d)            # <- mau ngingetin jgn pake fungsi bawaan begini ya ges, sy khilaf
            
def Min (a, b, c, d):
# menghasilkan nilai terkecil di antara a, b, c, d (integer)
# Tuliskan realisasi fungsi Min di bawah ini
    return min(a,b,c,d)             # <- mau ngingetin jgn pake fungsi bawaan begini ya ges, sy khilaf
